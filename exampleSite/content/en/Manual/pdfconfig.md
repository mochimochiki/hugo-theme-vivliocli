...
This is the template for colophon generation. This file is necessary when `colophon:true` is specified in the front matter of `_pdf.md`. If you use properties described in the `_pdf.md`, the shortcode `PDFParam` is useful.
